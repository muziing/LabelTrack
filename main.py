...
class MyWindow(QMainWindow, QtStyleTools):
    def __init__(self):
        ...
        self.load_worker = LoadWorker(self.canvas)
        self.load_worker.sinOut.connect(self.update_load_status)
        ...
        # 按钮
        self.pushButtonPlay.clicked.connect(self.play_video)  # 播放按钮
        ...
        self.zoom_widget.valueChanged.connect(self.paint_canvas)  # type: ignore
        ...
        self.actionModel.triggered.connect(self.model_select)
    ...
    def open_file(self):
        self.filePath, _ = QFileDialog.getOpenFileName(
            self, "Open file", "", "MP4 Video File(*.mp4)"
        )
    ...
    def load_file(self):
        ...
        self.load_worker.load_path(self.labelPath)
    ...
    def jump_frame(self, dpos=0):
        ...
        if dpos == 0:
            ...
            pos = (
                num + dpos
                if num + dpos <= self.canvas.numFrames
                else self.canvas.numFrames
            )
    ...
    def save_file_dialog(self, remove_ext=True):
        ...
        filename = os.path.splitext(self.filePath)[0] + ".csv"
    ...
    def save_labels(self, saved_path):
        results = []
        ...
        with open(saved_path, "w") as f:
            ...
            print(f"save results to {saved_path}")
